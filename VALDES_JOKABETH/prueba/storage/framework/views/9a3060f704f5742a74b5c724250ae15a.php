<!doctype html>
<html lang="es" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo e(asset('assets/')); ?>" data-template="vertical-menu-template-free">
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
    <title><?php echo $__env->yieldContent('title'); ?> - Proyecto Saleciano Costa Norte</title>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?php echo e(route('home')); ?>" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="<?php echo e(asset('assets/img/icono.jpeg')); ?>" alt="Proyecto Saleciano" style="width: 32px; height: 32px; margin-right: 8px;" />
                        </span>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Afiliados -->
                    <li class="menu-item <?php echo e(request()->routeIs('admin.afiliados.*') ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('admin.afiliados.index')); ?>" class="menu-link">
                                        ...
                                        <a class="dropdown-item" href="#" style="color: #000000;">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block" style="color: #000000;"><?php echo e(Auth::user()->name); ?></span>
                                                    <small class="text-muted" style="color: #000000;"><?php echo e(Auth::user()->email); ?></small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                    ...
                    <footer class="content-footer footer bg-footer-theme" style="background-color: #ffffff; border-top: 1px solid #808080;">
                        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0" style="color: #000000;">
                                © <?php echo e(date('Y')); ?>, Proyecto Saleciano Costa Norte
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
...
<?php /**PATH C:\xampp\htdocs\3a_programacion_web\VALDES_JOKABETH\prueba\resources\views/layaout/app.blade.php ENDPATH**/ ?>