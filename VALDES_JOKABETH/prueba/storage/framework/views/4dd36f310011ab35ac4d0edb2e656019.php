<?php $__env->startSection('title', 'Mediciones'); ?>
            ...
            <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #808080;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('admin.mediciones.create')); ?>" class="btn" style="background-color: #dc3545; color: #ffffff; border: none;">
                        ...
                        <table class="table table-bordered" style="border: 1px solid #808080; color: #000000;">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $mediciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e($medicion->id); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e($medicion->afiliado->nombre_completo); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e(number_format($medicion->peso, 2)); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e(number_format($medicion->talla, 2)); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e(number_format($medicion->imc, 2)); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;">
                                            <span class="badge" style="background-color: <?php echo e($medicion->clasificacion_color); ?>; color: #ffffff; border: 1px solid #808080;">
                                                <?php echo e($medicion->clasificacion_label); ?>

                                            </span>
                                        </td>
                                        <td style="color: #000000; border: 1px solid #808080;"><?php echo e($medicion->fecha_medicion->format('d/m/Y')); ?></td>
                                        <td style="color: #000000; border: 1px solid #808080;">
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('admin.mediciones.show', $medicion)); ?>" class="btn btn-sm" style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
                                                    <i class="bx bx-show" style="color: #ffffff;"></i>
                                                </a>
                                                <a href="<?php echo e(route('admin.mediciones.edit', $medicion)); ?>" class="btn btn-sm" style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
                                                    <i class="bx bx-edit" style="color: #ffffff;"></i>
                                                </a>
                                                <form action="<?php echo e(route('admin.mediciones.destroy', $medicion)); ?>" method="POST" class="d-inline" onsubmit="return confirm('¿Estás seguro de eliminar esta medición?');">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layaout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\3a_programacion_web\VALDES_JOKABETH\prueba\resources\views/admin/mediciones/index.blade.php ENDPATH**/ ?>