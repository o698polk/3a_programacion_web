            ...
            <div class="card" style="background-color: #ffffff; border: 1px solid #808080;">
                <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #808080;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.permissions.create') }}" class="btn" style="background-color: #dc3545; color: #ffffff; border: none;">
                        ...
                        <table class="table table-bordered" style="border: 1px solid #808080; color: #000000;">
                            ...
                            <tbody>
                                @forelse($permissions as $permission)
                                    <tr>
                                        <td style="color: #000000; border: 1px solid #808080;">{{ $permission->id }}</td>
                                        <td style="color: #000000; border: 1px solid #808080;">{{ $permission->name }}</td>
                                        <td style="color: #000000; border: 1px solid #808080;">{{ $permission->slug }}</td>
                                        <td style="color: #000000; border: 1px solid #808080;">{{ $permission->description ?? '-' }}</td>
                                        <td style="color: #000000; border: 1px solid #808080;">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('admin.permissions.show', $permission) }}" class="btn btn-sm" style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
                                                    <i class="bx bx-show" style="color: #ffffff;"></i>
                                                </a>
                                                <a href="{{ route('admin.permissions.edit', $permission) }}" class="btn btn-sm" style="background-color: #dc3545; color: #ffffff; border: 1px solid #808080;">
