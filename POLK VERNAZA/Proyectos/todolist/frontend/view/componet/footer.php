    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
        <h5 class="text-uppercase mb-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check2-square me-2" viewBox="0 0 16 16">
        ...
        <p class="text-light mb-0">
          <small>© <?php echo date('Y'); ?> Todo List. Todos los derechos reservados.</small>
        </p>
      </div>
        ...
        <ul class="list-unstyled">
          <li class="mb-2">
            <a href="index.php" class="text-light text-decoration-none footer-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-chevron-right me-1" viewBox="0 0 16 16">
          ...
          <li class="mb-2">
            <a href="crear_actividad.php" class="text-light text-decoration-none footer-link">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-chevron-right me-1" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z"/>
              </svg>
              Nueva Actividad
      ...
      <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
        ...
        <div class="d-flex gap-3">
          ...
          <a href="#" class="text-light social-icon" title="LinkedIn">
    ...
    <div class="row">
      <div class="col-12 text-center">
        <p class="text-light mb-0">
          <small>
            Desarrollado con 
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="red" class="bi bi-heart-fill mx-1" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
            </svg>
            por Polk Vernaza | 
            <a href="#" class="text-light text-decoration-none footer-link">Política de Privacidad</a> | 
            <a href="#" class="text-light text-decoration-none footer-link">Términos de Uso</a>
          </small>
        </p>
      </div>
    </div>
